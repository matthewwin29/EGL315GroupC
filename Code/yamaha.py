...
if __name__ == "__main__":
    ...
    command = 'set MIXER:Current/InCh/Fader/Level 18 0 -2000'
    run_command(command)
    time.sleep(4)

    command = 'set MIXER:Current/InCh/Fader/Level 18 0 -4000'
    run_command(command)
    time.sleep(3)
    command = 'set MIXER:Current/InCh/Fader/Level 18 0 -10000'
    run_command(command)
    time.sleep(1)
